        ...
        <div className="row gy-4 gy-lg-0 justify-content-xl-between">
          <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            <div className="widget">
              <a href="#!">
                <img src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/branding/wave-logo.svg"
                  alt="" className="bsb-tpl-logo-footer" />
              </a>
            </div>
          </div>
          <div className="col-12 col-md-4 col-lg-3 col-xl-2">
        ...
        <div className="row gy-4 gy-md-0">
          <div className="col-xs-12 col-md-7 order-1 order-md-0">
            ...
            <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
              Built by
              <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">BootstrapBrain</a>
