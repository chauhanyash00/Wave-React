        ...
        <div className="row gy-5 gy-lg-0 align-items-center">
          <div className="col-12 col-lg-4">
            <h2 className="display-3 fw-bolder mb-4">
              Our <span className="bg-text tw-text-4xl md:tw-text-7xl">Blog</span>
            </h2>
            <p className="fs-4 mb-4 mb-xl-5">
              Stay tuned and updated by the latest updates from our blog.
            </p>
            <a href="#!" className="btn bsb-btn-2xl btn-primary rounded-pill new-btn">More Plans</a>
          </div>
                  ...
                  <div className="col-12 col-lg-6">
                    <article>
                      <figure className="rounded overflow-hidden mb-3 bsb-overlay-hover">
                        <a href="#!">
                          <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                            src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/blog/blog-image-1.jpg"
                            alt="" />
                        </a>
                      </figure>
                      <div className="entry-header mb-3">
                        ...
                        <h2 className="entry-title h4 mb-0">
                          <a className="link-dark text-decoration-none" href="#!">How to Improve Your Project Management
                            Skills</a>
                        </h2>
                      </div>
                  ...
                  <div className="col-12 col-lg-6">
                    <article>
                      <figure className="rounded overflow-hidden mb-3 bsb-overlay-hover">
                        <a href="#!">
                          <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                            src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/blog/blog-image-2.jpg"
                            alt="" />
                        </a>
                      </figure>
                      <div className="entry-header mb-3">
                        ...
                        <h2 className="entry-title h4 mb-0">
                          <a className="link-dark text-decoration-none" href="#!">Modern Cybersecurity Trends to Watch in
                            2023</a>
                        </h2>
                      </div>
                      <div className="entry-footer">
                  ...
                  <div className="col-12 col-lg-6">
                    <article>
                      <figure className="rounded overflow-hidden mb-3 bsb-overlay-hover">
                        <a href="#!">
                          <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                            src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/blog/blog-image-3.jpg"
                            alt="" />
                        </a>
                      </figure>
                      <div className="entry-header mb-3">
                        ...
                        <h2 className="entry-title h4 mb-0">
                          <a className="link-dark text-decoration-none" href="#!">Health Care Job Growth Outpaces Other
                            Industries</a>
                        </h2>
                      </div>
                      <div className="entry-footer">
                  ...
                  <div className="col-12 col-lg-6">
                    <article>
                      <figure className="rounded overflow-hidden mb-3 bsb-overlay-hover">
                        <a href="#!">
                          <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy"
                            src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/blog/blog-image-4.jpg "
                            alt="" />
                        </a>
                      </figure>
                      <div className="entry-header mb-3">
                        ...
                        <h2 className="entry-title h4 mb-0">
                          <a className="link-dark text-decoration-none" href="#!">Five Essential Network Security Trends to
                            Watch</a>
                        </h2>
                      </div>
                      <div className="entry-footer">
