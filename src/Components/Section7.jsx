        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">
              We believe in client <br /><span className="bg-text tw-text-4xl md:tw-text-7xl">Satisfaction</span>. Here are
              some testimonials by our worthy clients.
            </h2>
          </div>
        </div>
      </div>
              ...
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/testimonial/testimonial-img-1.jpg"
                    alt="Luna John" />
                  <figcaption>
          ...
          <div className="col-12 col-md-4">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/testimonial/testimonial-img-2.jpg"
                    alt="Mark Smith" />
                  <figcaption>
                    <div className="bsb-ratings text-warning mb-3" data-bsb-star="4" data-bsb-star-off="1"></div>
                    <blockquote className="bsb-blockquote-icon mb-4">
                      We were looking for a company that could help us develop
                      a new website that was both visually appealing and
                      user-friendly.<msreadoutspan className="msreadout-line-highlight">
                        We are so happy with the
                        <msreadoutspan className="msreadout-word-highlight">results</msreadoutspan>, and we
                      </msreadoutspan>would highly recommend them to anyone looking for a new
                      website.
                    </blockquote>
          ...
          <div className="col-12 col-md-4">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/testimonial/testimonial-img-4.jpg"
                    alt="Luke Reeves" />
                  <figcaption>
                    <div className="bsb-ratings text-warning mb-3" data-bsb-star="5" data-bsb-star-off="0"></div>
                    <blockquote className="bsb-blockquote-icon mb-4">
                      We were looking for a company that could help us with
                      our branding. We needed a website and marketing
                      materials. They were able to create a brand identity
                      that we loved. They worked with us to develop a logo
                      that represented our company.
                    </blockquote>
