...
function Section1() {
  return (
   <>
    <section>
      <div className="tw-text-center tw-text-5xl md:tw-text-6xl max-sm:tw-text-4xl tw-font-bold tw-py-24">
        You will get the <br className="tw-hidden lg:tw-inline-block" />
        perfect
        <span className="bg-text tw-text-6xl md:tw-text-6xl max-sm:tw-text-4xl">resolutions</span>
        with <br className="tw-hidden lg:tw-inline-block" />
          ...
          <div className="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
            <div className="col-11 col-sm-6 col-lg-3">
              ...
              <p className="mb-3 text-secondary">
                We can help you to understand your target market and identify
                new opportunities for growth. We offer a variety of market
                research services, interviews, and focus groups.
              </p>
            ...
            <div className="col-11 col-sm-6 col-lg-3">
              <div className="badge bsb-tpl-bg-cyan text-primary p-3 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-alarm"
                  viewBox="0 0 16 16">
