        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">
              We are a group of <br /><span className="bg-text tw-text-5xl md:tw-text-6xl">innovative</span>
              ...
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/team/team-img-1.jpg"
                    alt="" />
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/team/team-img-2.jpg"
                    alt="" />
                  <figcaption className="m-0 p-4">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/team/team-img-3.jpg"
                    alt="" />
                  <figcaption className="m-0 p-4">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy"
                    src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/team/team-img-4.jpg"
                    alt="" />
                  <figcaption className="m-0 p-4">
