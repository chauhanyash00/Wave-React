        ...
        <div className="row gy-5 gy-lg-0 align-items-center">
          <div className="col-12 col-lg-4">
            <h2 className="display-3 fw-bolder mb-4">
              Our
              <span className="bg-text tw-text-4xl md:tw-text-7xl">Pricing</span>
            </h2>
            <p className="fs-4 mb-4 mb-xl-5">
              Explore our flexible pricing to find an excellent fit to run
              your business.
            </p>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="card border-0 border-bottom border-primary shadow-sm">
                      <div className="card-body p-4 p-xxl-5">
                        ...
                        <h4 className="display-3 fw-bold text-primary mb-0">
                          $45
                        </h4>
                        ...
                        <a href="#!" className="btn bsb-btn-2xl btn-danger rounded-pill new-btn">Choose Plan</a>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6">
                    <div
                      className="card border-0 border-bottom border-primary shadow-lg pt-md-4 pb-md-4 bsb-pricing-popular">
                      <div className="card-body p-4 p-xxl-5">
