        ...
        <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
          <div className="col-12 col-lg-6">
            <img className="img-fluid rounded" loading="lazy"
              src="https://bootstrapbrain.com/demo/templates/wave/wave-lite/assets/img/contact/contact-img-1.jpg"
              alt="" />
          </div>
          <div className="col-12 col-lg-6">
              ...
              <div className="col-12 col-xl-11">
                ...
                <div className="d-flex mb-4">
                  <div className="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-geo"
                      viewBox="0 0 16 16">
